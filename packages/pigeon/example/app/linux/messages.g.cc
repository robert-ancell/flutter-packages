...
PigeonExamplePackageMessageData* pigeon_example_package_message_data_new(
  ...
  self->zzz = zzz != nullptr ? *zzz : 0;
  self->zzz_set = zzz != nullptr;
  return self;
}
...
int64_t* pigeon_example_package_message_data_get_zzz(
    PigeonExamplePackageMessageData* self) {
  g_return_val_if_fail(PIGEON_EXAMPLE_PACKAGE_IS_MESSAGE_DATA(self), nullptr);
  return self->zzz_set ? &self->zzz : nullptr;
}
...
static FlValue* pigeon_example_package_message_data_to_list(
  ...
  fl_value_append_take(values, self->zzz_set ? fl_value_new_int(*self->zzz)
                                             : fl_value_new_null());
  return values;
}
...
pigeon_example_package_message_data_new_from_list(FlValue* values) {
  ...
  if (fl_value_get_type(value4) != FL_VALUE_TYPE_NULL) {
    zzz_value = fl_value_get_int(value4);
    zzz = &zzz_value;
  }
...
void pigeon_example_package_message_flutter_api_flutter_method_x(
  ...
  g_autoptr(FlValue) args = fl_value_new_list();
  fl_method_channel_invoke_method(self->channel, "flutterMethodX", args,
                                  cancellable, callback, user_data);
}
...
gboolean pigeon_example_package_message_flutter_api_flutter_method_x_finish(
  ...
  *return_value_set = is_set;
  *return_value = is_set ? fl_value_get_int(r) : 0;
